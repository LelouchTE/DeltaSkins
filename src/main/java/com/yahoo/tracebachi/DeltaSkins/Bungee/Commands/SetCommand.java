...
public class SetCommand
{
    ...
    public boolean onCommand(CommandSender sender, String[] args)
    {
        ...
        {
            sender.sendMessage(TextComponent.fromLegacyText(Prefixes.FAILURE +
                "Use update instead to fetch the original skin."));
            return true;
        }
        ...
        if(sourceProfile == null)
        {
            ...
            sender.sendMessage(TextComponent.fromLegacyText(Prefixes.FAILURE + "No data found for " + args[2] +
        ...
        else
        {
            ...
            sender.sendMessage(TextComponent.fromLegacyText(Prefixes.SUCCESS + "Copied skin data (" + args[1] + " <- " + args[2] + "). " +
